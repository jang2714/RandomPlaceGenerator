...
public class CourseInfoActivity2 extends RecommendBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(CourseInfoActivity2.this, CourseInfoActivity.class));
            }
        });
        ...
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(CourseInfoActivity2.this, CourseInfoActivity3.class));
            }
        });
