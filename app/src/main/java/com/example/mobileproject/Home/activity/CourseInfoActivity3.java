...
public class CourseInfoActivity3 extends RecommendBaseActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_course_info3);
        ...
        ImageButton button2 = findViewById(R.id.courseBack);

        button2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(CourseInfoActivity3.this, CourseInfoActivity2.class));
            }
        });
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(CourseInfoActivity3.this, MainActivity.class));
    }
